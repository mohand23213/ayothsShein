                ...
                children: [
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 10,),
                      Icon(Icons.email),
                      Container(child: TextField(decoration: InputDecoration(border: InputBorder.none,hintText: "البريد الاكتروني"),textAlign: TextAlign.center,controller: emailController,),width: 380,)
                    ],
                  ),),
                  SizedBox(height: 30,),
                  Container(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: 20,),
                        Icon(Icons.password),
                        Container(child: TextField(decoration: InputDecoration(border: InputBorder.none,hintText: "كلمة السر"),controller: passwordController,textAlign: TextAlign.center,obscureText: true,),width: 380,)
                      ],
                    ),),
                  SizedBox(height: 30,),
                  Container(
